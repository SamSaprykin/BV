...
const BodyTestimonial = ({
  ...
  return (
    <div className={`w-full mt-[20px] ${className}`}>
      <div className="w-full bg-gray-testimonial rounded-3xl p-[50px] h-[500px] flex flex-col justify-between items-start">
        <div className="flex flex-col">
          <h5 className="flex mb-[40px]">
            {Array(rating).fill(

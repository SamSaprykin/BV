...
const ServiceItem = ({ data, className }) => {
  return (
    <div
      className={`${className} rounded-3xl bg-gray-testimonial p-[50px] flex flex-col justify-between h-full`}
    >
      ...
      <div>
        <h2 className="font-medium text-[32px] mb-[11px] leading-tight">
          {data.title}
        </h2>
